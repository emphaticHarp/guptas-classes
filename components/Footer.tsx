        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <img src="/logo.jpg" alt="Gupta's Classes Logo" className="h-10 w-auto rounded-md" />
              <div>
                <h3 className="font-bold text-base text-white">Gupta's Classes</h3>
            ...
            <div className="flex gap-3">
              <a href="#" className="bg-gray-800 p-2 rounded-md hover:bg-gray-700 transition-colors text-sm font-semibold">
                f
              </a>
              <a href="#" className="bg-gray-800 p-2 rounded-md hover:bg-gray-700 transition-colors text-sm font-semibold">
                📷
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-bold text-base mb-6 text-white">Contact Info</h4>
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li className="flex items-start gap-3">
                <Phone size={18} className="flex-shrink-0 mt-0.5 text-gray-500" />
                <span>+91 XXXXXXXXXX</span>
              </li>
              <li className="flex items-start gap-3">
                <Mail size={18} className="flex-shrink-0 mt-0.5 text-gray-500" />
          ...
          {/* Courses */}
          <div>
            <h4 className="font-bold text-base mb-6 text-white">Courses Offered</h4>
            <ul className="space-y-3 text-sm text-gray-400">
